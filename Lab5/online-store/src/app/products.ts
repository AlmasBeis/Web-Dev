...
export const products = [
  ...
  {
    id: 11,
    name: 'Самокат Mijia Electric Scooter 1S',
    price: 339_900,
    description: `
          тип: электросамокат
    ...
    photo: 'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/hf2/h5d/32598673522718/xiaomi-mijia-electric-scooter-1s-chernyi-100309494-1.jpg',
    link: 'https://kaspi.kz/shop/p/mijia-electric-scooter-1s-chernyi-100309494/?c=750000000#!/item',
    rating: 5.0,
    category: "Спорт и туризм",
    likes: 0,
  },
  {
    id: 12,
    name: 'Обеденный стол Transformers Комфорт',
    price: 339_900,
    description: `тип: трансформер
            форма: прямоугольный
            материал: ЛДСП
            длина, см: 300
            ширина, см: 100
            ...
            цвет: белый
            страна: Казахстан`,
    photo: 'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/h9e/h05/49553540939806/transformers-komfort-1-300x100x78-sm-104220696-1.jpg',
    link: 'https://kaspi.kz/shop/p/transformers-komfort-1-300x100x78-sm-104220696/?c=750000000#!/itemhttps://kaspi.kz/shop/p/xiaomi-soocas-h5-fen-1800-w-101050689/?c=750000000#!/item',
    rating: 5.0,
    category: "Мебель",
    likes: 0,
  },
  {
    id: 13,
    name: 'Xiaomi Soocas H5 фен 1800 W',
    price: 339_900,
    description: `Технология NFC: Нет
          Цвет: серый
          Тип экрана: сенсорный, мультитач, IPS
          ...
          Объем встроенной памяти: 32 ГБ
          Емкость аккумулятора: 5000 мАч`,
    photo: 'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/h52/hf8/33990323273758/xiaomi-soocas-h5-fen-1800-w-101050689-1.jpg',
    link: 'https://kaspi.kz/shop/p/xiaomi-soocas-h5-fen-1800-w-101050689/?c=750000000#!/item',
    rating: 5.0,
  ...
  {
    id: 14,
    name: 'Speed Queen SF3JGBSP403NG22',
    price: 1_180_000,
    description: `установка: отдельностоящая
          управление: электронное
          максимальная загрузка белья: 10.2 кг
          класс потребления электроэнергии: A
          скорость вращения при отжиме: 1200 об/мин
          защита от протечек воды: Да
          цвет: серый`,
    photo: 'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/hdb/h40/47074823700510/speed-queen-sf3jgbsp403ng22-seryj-102827240-1.jpg',
    link: 'https://kaspi.kz/shop/p/speed-queen-sf3jgbsp403ng22-seryi-102827240/?c=750000000#!/item',
    rating: 5.0,
